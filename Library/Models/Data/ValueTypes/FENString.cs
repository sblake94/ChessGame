...
namespace Library.Models.Data.ValueTypes
{
    public class FENString
    {
        ...
        {
            return IsValid(_input)
                ? new Success<FENString>(new FENString(_input))
                : new Failure<FENString>(new Exception("Invalid FEN string"));
        }
